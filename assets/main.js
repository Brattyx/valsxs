...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#container01', { style: 'blur-in', speed: 1875, intensity: 8, delay: 1625, replay: false });
		onvisible.add('#image02', { style: 'blur-in', speed: 1000, intensity: 6, delay: 125, replay: false });
		onvisible.add('#image01', { style: 'blur-in', speed: 1000, intensity: 6, delay: 125, replay: false });
